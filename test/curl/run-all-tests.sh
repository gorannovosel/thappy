...
run_test_script "test/curl/05-client-therapist-registration.sh" "05 - ROLE-BASED REGISTRATION TESTS"
run_test_script "test/curl/06-client-profile-flow.sh" "06 - CLIENT PROFILE MANAGEMENT TESTS"
run_test_script "test/curl/07-therapist-profile-flow.sh" "07 - THERAPIST PROFILE MANAGEMENT TESTS"
...
echo "  ./test/curl/05-client-therapist-registration.sh # Role-based registration tests"
echo "  ./test/curl/06-client-profile-flow.sh # Client profile management tests"
echo "  ./test/curl/07-therapist-profile-flow.sh # Therapist profile management tests"
echo ""
